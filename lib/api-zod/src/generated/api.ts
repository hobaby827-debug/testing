...
export const ListTeamsResponseItem = zod.object({
  ...
  losses: zod.number(),
  otLosses: zod.number(),
  solLosses: zod.number(),
  regulationWins: zod.number(),
  rowWins: zod.number(),
  points: zod.number(),
  gamesPlayed: zod.number(),
  gamesRemaining: zod.number(),
  homeGamesRemaining: zod.number(),
  awayGamesRemaining: zod.number(),
  goalsFor: zod.number(),
  goalsAgainst: zod.number(),
  goalDifferential: zod.number(),
  pointsPercentage: zod.number(),
  maxPoints: zod.number(),
  streak: zod.string(),
  clinchStatus: zod.string().optional(),
});
...
export const CreateTeamBody = zod.object({
  ...
  city: zod.string(),
  division: zod.string(),
  gmName: zod.string().optional(),
  primaryColor: zod.string(),
  secondaryColor: zod.string(),
  logoUrl: zod.string().optional(),
  wins: zod.number().optional(),
  losses: zod.number().optional(),
  otLosses: zod.number().optional(),
  solLosses: zod.number().optional(),
  regulationWins: zod.number().optional(),
  rowWins: zod.number().optional(),
  goalsFor: zod.number().optional(),
  goalsAgainst: zod.number().optional(),
  gamesRemaining: zod.number().optional(),
  homeGamesRemaining: zod.number().optional(),
  awayGamesRemaining: zod.number().optional(),
