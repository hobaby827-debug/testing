...
const teams = [
  ...
  { name: "Lehigh Valley Phantoms",   abbreviation: "LV",  city: "Lehigh Valley",division: "Eastern", gm_name: "",         primary_color: "#f74902", secondary_color: "#000000" },
  ...
  { name: "Cleveland Monsters",       abbreviation: "CLE", city: "Cleveland",    division: "Western", gm_name: "",         primary_color: "#041e42", secondary_color: "#ce1126" },
];
